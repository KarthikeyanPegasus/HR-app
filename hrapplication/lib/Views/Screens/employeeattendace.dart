...
class DtwiseEmployeeing extends StatefulWidget {
  const DtwiseEmployeeing({
    Key? key,
...
class _DtwiseEmployeeState extends State<DtwiseEmployeeing> {
  int _selectedIndex = 1;
  DateTime fromTime = DateTime(
      DateTime.now().day - 1, DateTime.now().month, DateTime.now().day);
  DateTime toTime =
