...
import 'package:hrapplication/Views/Screens/hrallsearch.dart';
...
class _DashboardState extends State<Dashboard> {
  ...
  late int present, absent, late, early, overall, overtime;
  List<String> shortlist = ["Present", "Absent", "Overtime"];
