...
import 'package:hrapplication/Views/Screens/employeeattendace.dart';
import 'package:hrapplication/Views/Screens/hralldash.dart';

import 'hrallsearch.dart';

class EmployeeDashboarding extends StatefulWidget {
  const EmployeeDashboarding(
...
class _EmployeeDashboardState extends State<EmployeeDashboarding> {
    ...
    setState(() {
      ...
      if (_selectedIndex == 1) {
        Navigator.of(context).pushReplacement(new MaterialPageRoute(
            builder: (BuildContext context) => DtwiseEmployeeing(
                  empname: name,
                  empid: widget.emp_id,
                  empdsg: desig,
